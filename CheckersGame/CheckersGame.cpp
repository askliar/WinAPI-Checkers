...
INT_PTR CALLBACK	FPlayerDialog(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam);
	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_CHECKERSGAME, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CHECKERSGAME));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CHECKERSGAME));
	wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCE(IDC_CHECKERSGAME);
